...
if (screen.width <= 575 && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) === true) {
...
if (window.matchMedia("(min-width: 992px)").matches) {
  header
    .fromTo(".desc h1", { x: -500, autoAlpha: 0 }, { x: 0, autoAlpha: 1, duration: 0.6, delay: 0.2 }, "first")
    .fromTo(".desc p", { x: -500, autoAlpha: 0 }, { x: 0, autoAlpha: 1, duration: 0.6, delay: 0.2 }, "first")
    .fromTo(".employee-img", { display: "none", autoAlpha: 0 }, { display: "block", autoAlpha: 1, duration: 0.6 }, "second")
    .fromTo(".title", { display: "none", autoAlpha: 0 }, { display: "block", autoAlpha: 1, duration: 0.6 }, "second")
    .fromTo(".rect", { y: 1000, display: "none" }, { y: 0, display: "block", duration: 0.6, delay: 0.1 }, "third")
    .fromTo(".desc .btn .solusiButton", { display: "none", autoAlpha: 0 }, { display: "block", autoAlpha: 1, duration: 0.6, delay: 0.1 }, "third")
