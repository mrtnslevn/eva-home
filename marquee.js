...
if(window.matchMedia("(min-width: 992px)").matches) {
  ...
  //   .fromTo("#slider1", { x: 1300 }, { x: 0 });
          ...
          .fromTo("#anim1",  { opacity: 0, scale: 1.3, duration: 0.6 },  { opacity: 1, scale: 1, duration: 0.7 })
          .fromTo("#anim1", {y: 350}, {y: 0, duration: 0.8, ease: 'power2.inOut'})
  ...
  tl4
    .fromTo(".anim5 .judul", { opacity: 0, scale: 1.3, duration: 0.6 },  { opacity: 1, scale: 1, duration: 0.7 })
    .fromTo(".anim5", {y: 300}, {y: 0, duration: 0.8, })
